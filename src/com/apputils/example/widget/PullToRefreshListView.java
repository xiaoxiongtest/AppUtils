...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private static final int TAP_TO_REFRESH = 1;//准备开始下拉
	private static final int PULL_TO_REFRESH = 2; //下拉
	private static final int RELEASE_TO_REFRESH = 3; //释放
	protected static final int REFRESHING = 4;//正在刷新
	...
	protected void onAttachedToWindow() {
		...
		setSelection(1);
		Log.d(TAG, "调用了onAttachedToWindow");
	}
	...
	private void applyHeaderPadding(MotionEvent ev) {
		...
		Log.d(TAG, "move 历史点数为："+pointerCount);
		...
		for (int p = 0; p < pointerCount; p++) {
			if (mRefreshState == RELEASE_TO_REFRESH) {
				...
				Log.d(TAG, "top-padding:"+topPadding);
